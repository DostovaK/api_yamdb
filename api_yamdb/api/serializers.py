...
class ReviewSerializer(serializers.ModelSerializer):
    ...
    title = serializers.SlugRelatedField(slug_field='name', read_only=True, default=serializers.CurrentUserDefault())
    ...
    class Meta:
        ...
        read_only_fields = (
            ...
            'author',)
        model = Review
        validators = [UniqueTogetherValidator(queryset=Review.objects.all(), fields=['author', 'title'])]
